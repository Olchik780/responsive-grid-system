...
Когда вы только начнёте, особенно полезно иметь под рукой контрольную сетку,
...
Вау. Это длинная статья. Кажется, прошла целая вечность, пока писал её. (Спасибо, 
что прочитали её до конца! Надеюсь, читая статью, вам так не показалось :stuck_out_tongue:).

Как вы увидели, в этой статье,  шаги по созданию гибкой системы координат относительно просты.
Этапами, которые запутывают большинство людей, 
являются шаги 5 (определения положения отступов) и 8 (создание адаптивной раскладки).
...
адаптивной сетки, и я надеюсь, увидеть вашу специально созданную сетку для 
